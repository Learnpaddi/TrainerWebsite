...
exports.verifyCertificate = exports.issueCertificateOnPass = exports.submitCourseExamAttempt = exports.startCourseExam = exports.verifyExamPayment = exports.createExamOrder = exports.completeCourseForExam = exports.checkPrismaDatabase = void 0;
...
async function getCourseExam(courseId) {
    ...
    if (embeddedExam && typeof embeddedExam === 'object') {
        const embeddedExamData = embeddedExam;
...
async function ensureExamAccess(userId, courseId) {
    ...
    const enrollment = enrollmentSnapshot.exists
        ...
        : normalizePrismaEnrollment(prismaEnrollment);
